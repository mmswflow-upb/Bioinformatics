...
- Visualizes similarities as a heatmap + shows best alignment in the same figure
"""
...
def main():
    ...
    print(f"Best local alignment score in best window pair: {best_score}")
    ...
    # If alignment is very long, show only first N characters to keep readable
    max_chars = 140
    ...
    ax_align.set_title(
        f"Best local alignment between genomes "
        f"(windows {best_i} / {best_j}, score={best_score})",
        pad=20,
    )
